...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <div class="hero-section position-relative mb-5 rounded-4 overflow-hidden shadow-lg">
            <img src="{{ asset('images/two.jpg') }}" alt="Événement Culturel à Cotonou" class="img-fluid w-100 hero-image">
            <div class="hero-overlay d-flex align-items-center">
                <div class="container text-center text-white">
                    <div class="hero-meta bg-dark bg-opacity-50 d-inline-block px-4 py-2 rounded-pill mb-3">
                        <span class="badge bg-danger me-2">Événement</span>
                        <span><i class="far fa-calendar-alt me-1"></i> 15 Novembre 2024</span>
                    </div>
                    <h1 class="display-4 fw-bold mb-4 text-black">Événement Culturel à Cotonou</h1>
                    <p class="lead mb-0 text-shadow">Une célébration vibrante des traditions, arts et musique locale</p>
                </div>
            </div>
        </div>
